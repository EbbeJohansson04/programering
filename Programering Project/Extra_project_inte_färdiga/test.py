...
class BlackJack():
    ...
    def play(self):       
        ...
        while play_again == "j":
            ...
            # who winns?
            if self.player_hand.sum() > self.computer_hand.sum() and self.player_hand.sum() <= 21:
                print(self.player_hand.name, "wins")
            elif self.computer_hand.sum() > self.computer_hand.sum() and self.computer_hand.sum() <= 21:
