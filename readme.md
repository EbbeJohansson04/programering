...
## Lördag
Blev övertalad av Joel att försöka göra ett objekt orienterat black jack och har suttit med det lite för längen men är tyvärr inte klar. Jag vet att jag inte riktigt skrivit mycket här men det är för att jag inte riktigt har haft problem med min kod på samma sätt som alla andra utan jag har istället problem med att "skriva"/börja skriva koden så det blir inte särskillt mycket att skriva. (problem med att komma på vad jag ska programer/vad för project samt glömmer hur man ska använda allt osv).
...
Kod fast ej object orienterad: (orka inte ta bort alla #)
